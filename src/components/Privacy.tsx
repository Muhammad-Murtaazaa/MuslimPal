  ...
  return (
    <div className="max-w-3xl mx-auto p-6">
      <div className="text-center mb-10">
        <h1 className="text-4xl font-bold text-gray-800 dark:text-pal-gold mb-2">Privacy Policy</h1>
      ...
      <div className="space-y-6">
        ...
        <section className="bg-white dark:bg-pal-surface/90 rounded-xl border border-gray-100 dark:border-pal-sage/25 shadow-sm p-6">
          <h2 className="text-xl font-semibold text-gray-800 dark:text-pal-gold mb-3">1. Data We Collect</h2>
          ...
          <p className="text-gray-600 dark:text-white/85 leading-relaxed">
            ...
            your browser&apos;s <code className="bg-gray-100 dark:bg-pal-bg/60 px-1 rounded text-sm">localStorage</code>.
            This data stays on your device unless you explicitly submit information to an external service.
          </p>
        </section>

        <section className="bg-white dark:bg-pal-surface/90 rounded-xl border border-gray-100 dark:border-pal-sage/25 shadow-sm p-6">
          <h2 className="text-xl font-semibold text-gray-800 dark:text-pal-gold mb-3">2. Third-Party Services</h2>
          <p className="text-gray-600 dark:text-white/85 leading-relaxed mb-3">
        ...
        <section className="bg-white dark:bg-pal-surface/90 rounded-xl border border-gray-100 dark:border-pal-sage/25 shadow-sm p-6">
          <h2 className="text-xl font-semibold text-gray-800 dark:text-pal-gold mb-3">3. Location Data</h2>
          <p className="text-gray-600 dark:text-white/85 leading-relaxed">
        ...
        <section className="bg-white dark:bg-pal-surface/90 rounded-xl border border-gray-100 dark:border-pal-sage/25 shadow-sm p-6">
          <h2 className="text-xl font-semibold text-gray-800 dark:text-pal-gold mb-3">4. AI Interactions</h2>
          <p className="text-gray-600 dark:text-white/85 leading-relaxed">
        ...
        <section className="bg-white dark:bg-pal-surface/90 rounded-xl border border-gray-100 dark:border-pal-sage/25 shadow-sm p-6">
          <h2 className="text-xl font-semibold text-gray-800 dark:text-pal-gold mb-3">5. Open Source</h2>
          <p className="text-gray-600 dark:text-white/85 leading-relaxed">
        ...
        <section className="bg-white dark:bg-pal-surface/90 rounded-xl border border-gray-100 dark:border-pal-sage/25 shadow-sm p-6">
          <h2 className="text-xl font-semibold text-gray-800 dark:text-pal-gold mb-3">6. Changes to This Policy</h2>
          <p className="text-gray-600 dark:text-white/85 leading-relaxed">
